...
* Score Plan (100pt): Evaluate clarity (25), comprehensiveness (25), feasibility (25), and consistency (25).
* List Deficiencies: Create a prioritized task list (`- [ ]`) of gaps, omissions, or ambiguities.
* Improve: Edit the Plan to resolve deficiencies.
* Final Check: Confirm no logical contradictions or missing elements.
